...
# Instructions</br>
Execute the following from the command line and furnish the username and password from NRG Stache:</br>
```ros2 run spot_manipulation_driver follow_joint_trajectory_action_server 192.168.50.3```</br>
